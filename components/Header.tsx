...
const products = [
  ...
  {
    name: "Analytics",
    description: "Understand where visitors are coming from.",
    href: "#",
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013894] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              {/* Thay thế dòng sau với icon đóng của bạn */}
                ...
                <Disclosure as="div" className="-mx-3">
                  {({ open }) => (
                    <>
                      ...
                      <Disclosure.Panel className="px-3 pt-2 pb-4 text-gray-500">
                        {/* Nội dung của Disclosure.Panel */}
                      </Disclosure.Panel>
                    </>
                  )}
                </Disclosure>
